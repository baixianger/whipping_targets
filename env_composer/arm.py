...
general_params = [
    {},
    {'name': 'actuator_1', 'forcerange': [-87, 87], 'ctrlrange': [-2.8973, 2.8973],
     'gainprm': [4500,], 'biasprm': [0, -4500, -450], 'dyntype': None, 'biastype':'affine'},
    {'name': 'actuator_2', 'forcerange': [-87, 87], 'ctrlrange': [-1.7628, 1.7628],
     'gainprm': [4500,], 'biasprm': [0, -4500, -450], 'dyntype': None, 'biastype':'affine'},
    {'name': 'actuator_3', 'forcerange': [-87, 87], 'ctrlrange': [-2.8973, 2.8973],
     'gainprm': [3500,], 'biasprm': [0, -3500, -350], 'dyntype': None, 'biastype':'affine'},
    {'name': 'actuator_4', 'forcerange': [-87, 87], 'ctrlrange': [-3.0718, -0.0698],
     'gainprm': [3500,], 'biasprm': [0, -3500, -350], 'dyntype': None, 'biastype':'affine'},
    {'name': 'actuator_5', 'forcerange': [-12, 12], 'ctrlrange': [-2.8973, 2.8973],
     'gainprm': [2000,], 'biasprm': [0, -2000, -200], 'dyntype': None, 'biastype':'affine'},
    {'name': 'actuator_6', 'forcerange': [-12, 12], 'ctrlrange': [-0.0175, 3.7525],
     'gainprm': [2000,], 'biasprm': [0, -2000, -200], 'dyntype': None, 'biastype':'affine'},
    {'name': 'actuator_7', 'forcerange': [-12, 12], 'ctrlrange': [-2.8973, 2.8973],
     'gainprm': [2000,], 'biasprm': [0, -2000, -200], 'dyntype': None, 'biastype':'affine'},
]
